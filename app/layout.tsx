...
export default function RootLayout({
  ...
  return (
    <html lang="en" suppressHydrationWarning>
      <head>
        <title>LangChain Retrieval</title>
        <link rel="shortcut icon" href="/images/favicon.ico" />
        <meta
          name="description"
          content="LangChain.js Retrieval with Supabase vector store"
        />
        <meta property="og:title" content="LangChain Retrieval" />
        <meta
        ...
        <meta name="twitter:title" content="LangChain Retrieval" />
        <meta
