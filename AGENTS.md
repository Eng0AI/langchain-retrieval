...
A LangChain.js retrieval chain with Supabase vector store for document Q&A, powered by the Vercel AI SDK.
...
|-------|------|-------------|
| build-and-deploy | `.claude/skills/build-and-deploy/SKILL.md` | Build and deploy this Next.js LangChain retrieval application with Supabase vector store. Use when building, deploying, setting up vector store, or preparing the project for production. |
